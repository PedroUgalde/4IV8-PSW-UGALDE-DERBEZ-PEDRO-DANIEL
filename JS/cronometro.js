//obtener valores que vienen de partes diferentes de la variables
//variables [id]

let temporizador = document.getElementById('temporizador');
let iniciar = document.getElementById('iniciar');
let resetear = document.getElementById('recetear');
...
function iniciarContador(){
    if(verificador== false){
        //funcion nonima que incrementa el tiempo y lo agregar a la etiqueta p
